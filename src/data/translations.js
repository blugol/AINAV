...
export const translations = {
    en: {
        ...
        hero: {
            title: 'AI Nav',
            subtitle: 'Check the latest AI news at a glance and connect directly to the AI features you need by category.'
        },
        sections: {
        ...
        footer: {
            rights: '© 2026 AI Nav. All rights reserved.'
        },
        categories: {
            all: 'All',
            image: 'Image',
    ...
    ko: {
        ...
        hero: {
            title: 'AI Nav',
            subtitle: '매일 쏟아지는 최신 AI 뉴스를 한눈에 확인하고, 나에게 필요한 AI 기능을 카테고리별로 바로 연결해 보세요.'
        },
        sections: {
            categories: '카테고리',
            subtitle: '어떤 AI 찾으세요?',
    ...
    ja: {
        ...
        hero: {
            title: 'AI Nav',
            subtitle: '最新のAIニュースを一目で確認し、必要なAI機能をカテゴリ別にすぐに見つけることができます。'
        },
        sections: {
            categories: 'カテゴリー',
    ...
    zh: {
        ...
        hero: {
            title: 'AI Nav',
            subtitle: '一目了然地查看最新的 AI 新闻，并按类别直接连接到您需要的 AI 功能。'
        },
        sections: {
            categories: '分类',
            subtitle: '您在寻找什么 AI？',
